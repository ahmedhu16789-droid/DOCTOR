...
class DoctorUpsertRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'payroll.model' => ['required', Rule::in(['FIXED_SALARY', 'PERCENTAGE', 'HYBRID', 'PER_CASE', 'HYBRID_PER_CASE'])],
            'payroll.baseSalary' => ['required', 'numeric', 'min:0'],
            'payroll.commissionPercentage' => ['nullable', 'numeric', 'min:0', 'max:100'],
            'payroll.perCaseAmount' => ['nullable', 'numeric', 'min:0', 'required_if:payroll.model,PER_CASE,HYBRID_PER_CASE'],
            'payroll.perDayCapCases' => ['nullable', 'integer', 'min:1'],
