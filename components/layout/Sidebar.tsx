  ...
  const MENU_ITEMS = [
    ...
    },
    {
      ...
      items: [
        ...
        { id: 'platform-dashboard', label: 'platform_dashboard', icon: Shield, roles: [UserRole.PLATFORM_ADMIN] },
    ...
    },
    {
      ...
      items: [
        ...
        { id: 'cash-session', label: 'cash_session', icon: Banknote, roles: [UserRole.ADMIN, UserRole.BRANCH_MANAGER, UserRole.RECEPTIONIST] },
      ]
    }
  ];
        ...
        {MENU_ITEMS.map((group, idx) => {
          const filteredItems = group.items.filter(item => {
            if (userRole === UserRole.PLATFORM_ADMIN) {
              return item.roles?.includes(UserRole.PLATFORM_ADMIN);
            }
