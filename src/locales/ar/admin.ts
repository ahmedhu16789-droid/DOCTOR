export const admin = {
    ...
    "schedule": "الجدول",
    "doctor_search_placeholder": "ابحث باسم الطبيب أو رقم الهاتف",
    "all_specialties": "كل التخصصات",
    "all_branches": "كل الفروع",
    "doctors_found": "طبيب/أطباء",
    "no_doctors_found": "لا يوجد أطباء مطابقون للفلاتر المحددة.",
    "consultation_fee": "سعر الكشف",
    "branch_assignment": "توزيع الفروع",
    "weekly_schedule": "الجدول الأسبوعي",
    "monthly_base_salary": "الراتب الأساسي الشهري",
