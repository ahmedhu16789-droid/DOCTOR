export const common = {
    ...
    "cash_session": "جلسة الكاش",
    "settings": "الإعدادات",
    "sign_out": "تسجيل الخروج",
    "management": "الإدارة",
    "finance": "المالية",
    "platform_dashboard": "العيادات",
    ...
    "migration_preview": "معاينة الترحيل",
    "delay_detection_alert_title": "تم اكتشاف تأخير للطبيب",
    "delay_detection_alert_body": "التأخير الحالي {{delay}} دقيقة. سيتأثر {{count}} موعد قادم. الإزاحة المقترحة: +{{shift}} دقيقة.",
    ...
    "consent_preferences": "تفضيلات الموافقة",
    "consent_treatment": "موافقة العلاج",
    "consent_privacy": "موافقة الخصوصية",
    "consent_communication": "موافقة التواصل",
